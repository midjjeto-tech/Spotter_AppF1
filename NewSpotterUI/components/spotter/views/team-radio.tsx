...
// «Из самых лаконичных», а не «самая лаконичная»: режим сужает выбор до окна
// коротких формулировок, но не отменяет разнообразие
// (core/radio/phrases.py::shortest_window). Прежний текст обещал одну строку —
// и ровно её и получал пилот, одну на весь заезд.
const PHRASE_LENGTHS: { id: string; label: string; hint: string }[] = [
  { id: "short", label: "Коротко", hint: "Выбирает из самых лаконичных формулировок." },
