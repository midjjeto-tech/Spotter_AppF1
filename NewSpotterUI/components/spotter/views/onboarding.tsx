    ...
    <Panel label="Шаг 1 — телеметрия из игры">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {status === "port_busy" && (
            <Fault>
              Порт {t?.udp_port} уже занят другим приложением. Его используют SimHub,
              Pits n&nbsp;Giggles, Telemetry Tool и другие телеметрийные утилиты —
              а ещё вторая копия Spotter. Закройте её, и приложение подхватит порт
